...
import com.woreye.pojo.ApiBodies;
import com.woreye.pojo.FormData;
import com.woreye.pojo.Raw;
...
public class InputData {
    ...
    public void inPutShenMaXinShenDai(){
        String txtFile = readTxtFile(new File("C:\\Users\\woreye\\Desktop\\PostMan个人\\什马新生贷.postman_collection.json"));
        JSONObject j = JSON.parseObject(txtFile);
